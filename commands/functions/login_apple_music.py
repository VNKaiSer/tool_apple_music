...
def run(run_check = False, run_delete = False):
    try: 
        ...
        # data = db_instanSUPPORTSUPPORTce.fetch_data(table_name="mail", columns=["*"], condition="isRunning = 'N' and count_run <= 3 limit 1") 
        # print(data)
                ...
                while time_reload < 2:
                    ...
                    try: 
                        ...
                        if lis[2] != "":
                            ...
                            db_instance.update_data(table_name="pay", set_values={"number_use": data_card[0][6]+1, "is_running": 'N'}, condition=f"id = {data_card[0][0]}")

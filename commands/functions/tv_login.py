...
def run():    
    ...
    try: 
        ...
        WebDriverWait(driver, 60).until(EC.visibility_of_element_located((By.XPATH, '//*[@id="content-area"]/div/iframe')))
        driver.switch_to.frame(driver.find_element(By.XPATH, '//*[@id="content-area"]/div/iframe'))
        WebDriverWait(driver, 60).until(EC.visibility_of_element_located((By.TAG_NAME, 'li')))
    ...
    try:
        ...
        while True:
            ...
            driver.find_element(By.XPATH,'//*[@id="modal-0"]/div/div[2]/div/button').click()
        ...
        time.sleep(5)
        WebDriverWait(driver, 15).until(EC.visibility_of_element_located((By.XPATH,'//*[@id="app"]/camk-modal/div/camk-modal-button-bar/camk-button-bar/div/div[2]/button')))

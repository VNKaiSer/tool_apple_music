...
def login_apple_id(data, driver):
    ...
    try:
        ...
        time.sleep(1)
        select_q2 = Select(select_element[1])
        select_q2.select_by_index(0)
        time.sleep(1)
        select_q3 = Select(select_element[2])
        select_q3.select_by_index(0)
        time.sleep(1)
        ...
        inputs[0].send_keys(data['question']['school'])
        time.sleep(1)
        inputs[1].send_keys(data['question']['dream'])
        time.sleep(1)
        inputs[2].send_keys(data['question']['parent'])
        time.sleep(1)
        # Nhấn nút 
